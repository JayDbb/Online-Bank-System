<%@ Page Title="Add Account" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Add-Account.aspx.cs" Inherits="Online_Bank_System.Add_Account" %>
   ...
   />
    ...
    <asp:CustomValidator 
       ...
       />
                            ...
                            <p class="mt-2" > Don't Have One? <a href="/create" data-bs-toggle="modal" data-bs-target="#createAccountModal">Create an Account</a></p>
                        </asp:Panel>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header text-white" style="background-color: #c93853;">
                <h5 class="modal-title" id="createAccountModalLabel">Create New Account</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
                <asp:Panel ID="PanelCreateAccount" runat="server">
                   

                    <div class="form-group mb-3">
                        <label for="newTxtPassword" class="form-label">PIN For Account</label>
                        <asp:TextBox 
                            ID="newTxtPassword" 
                            CssClass="form-control" 
                            TextMode="Password" 
                    ...
                    <div class="form-group mb-3">
                        <label for="ddlAccountType" class="form-label">Account Type</label>
                        <asp:DropDownList 
                            ID="ddlAccountType" 
                            CssClass="form-control" 
                            runat="server">
